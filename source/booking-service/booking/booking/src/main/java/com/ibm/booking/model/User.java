...
public class User {
	...
	public User(ObjectId _id, String name, String password, String firstName, String lastName, String email,
	...
	public void setPassword(String password) {
	  ...
	  public User() {}
	public User(ObjectId _id, String name, String password, String role) {
		super();
		this._id = _id;
		this.name = name;
		this.password = password;
